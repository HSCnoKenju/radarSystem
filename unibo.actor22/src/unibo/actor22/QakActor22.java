...
public abstract class QakActor22 extends ActorBasic {
    ...
    public QakActor22(@NotNull String name) {
        ...
        if (Qak22Context.getActor(name) == null) {
            ...
            ColorsOut.outerr("QakActor22 | WARNING: an actor with name " + name + " already exists");
    }
    ...
    protected void autoMsg(IApplMessage msg) {
        ...
        if (msg.msgReceiver().equals(getName()))
            sendMsg(msg);
            // sendMessageToActor(msg,msg.msgReceiver());
        else
            ColorsOut.outerr("QakActor22 | autoMsg wrong receiver");
    }
    ...
    protected void forward(IApplMessage msg) {
        ...
        if (msg.isDispatch())
            ...
            ColorsOut.outerr("QakActor22 | forward requires a dispatch");
    }
    ...
    protected void request(IApplMessage msg) {
        if (msg.isRequest())
            ...
            ColorsOut.outerr("QakActor22 |  requires a request");
    }
